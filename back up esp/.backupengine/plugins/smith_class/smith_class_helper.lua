...
local function showChoiceMenu()
    ...
    local choices = {
        {
            text = "What's the finest steel you've ever forged?",
            action = function()
                close()
        ...
        {
            text = "Any rare materials come through your forge?",
            action = function()
                close()
        ...
        {
            text = "Tell me about your most challenging commission",
            action = function()
                close()
        ...
        {
            text = "What makes truly exceptional weaponry?",
            action = function()
                close()
        ...
        {
            text = "Any advice for an aspiring bladesmith?",
            action = function()
                close()
    ...
    table.insert(content, {
        type = ui.TYPE.Text,
        props = {
            text = "What would you like to ask this master smith?",
            textSize = 28,
