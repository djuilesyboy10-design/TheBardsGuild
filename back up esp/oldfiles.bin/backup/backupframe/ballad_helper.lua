            ...
            content = ui.content({
                {
                    ...
                    props = {
                        text = option.label,
                        textSize = 24,
                        textColor = util.color.rgb(0.85, 0.1, 0.1), -- 🔴 RED for Answers
                    }
                }
            }),
            events = {
                mouseClick = async:callback(function()
                    ...
                    -- ⚡ 2. Send the Outcome data to the Global Effect Handler
                    -- This triggers the Journal and the Balmora Thunderstorm
                    core.sendGlobalEvent('ApplyBardicEffect', option.outcome)
                end)
            }
        })
    end
