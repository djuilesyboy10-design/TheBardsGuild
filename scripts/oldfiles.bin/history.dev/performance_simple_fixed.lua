-- performance_simple_fixed.lua
-- Fixed console commands that work in player context
...
_G.bardPerform = function()
    ...
    -- Count audience (player context version)
    local audience = 0
    ...
    -- Send performance event using player context
