-- performance_event.lua
-- Simple event-driven performance system based on weather_sync pattern
...
local function onPerformanceEvent(data)
    ...
    if I.JMCG_QuestData then
        -- Small influence boost for good performances
        if outcome.reputationBonus > 0 then
            world.sendEvent('JMCG_BardInfluence_Update', {
