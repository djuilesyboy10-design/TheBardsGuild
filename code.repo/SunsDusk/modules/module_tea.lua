...
-- R = Add water (500mL or 1000 mL)
-- F = Brew Tea (2x required for 500mL or 4x required for 10000mL)
-- When tea is brewed, r changes to "pour" which then adds tea to your inventory if you have a tea cup
-- 250 mL = 1 tea cup, so 2 tea cups for 500 mL or up to 4 for 10000 mL)
