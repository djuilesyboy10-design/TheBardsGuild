...
-- NEW: UI AND REGISTERING STATICS
...
local function isBathStatic(recordId)
...
local function bathStaticRaycastChanged()
	...
	if hitRecordId and (G_raycastResultType == "Static" or G_raycastResultType == "Activator") and isBathStatic(hitRecordId) then
