...
local function onLoad(originalData)
	...
	if SkillFramework then
		SkillFramework.registerSkill(skillId, {
			name = "Cooking",
			description = [[Cooking skill is measured by the ability to prepare dishes and draw out the beneficial properties of ingredients 
			when combined over a fire. A Gourmet Chef can turn a handful of scraps into something worth savoring.]],
